...
st.markdown("Aplikasi Mechine Leraning Classification untuk Memprediksi kualitas Jeruk")
...
if st.button ("Prediksi" , type = "primary"):
    ...
    st.success(f"Model Memprediksi **{prediksi}** dengan ingkat keyakinan **{persentase*100:.2f}**%")
    st.balloons()

st.divider()
st.caption("Dibuat oleh **Aldino** dengan :tangerine:")
